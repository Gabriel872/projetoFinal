...
namespace DapperTrabalhoFinal.Controllers
{
    ...
    public class SubThemeController
    {
        ...
        [HttpPost]
        public string RegisterSubThemes([FromBody] SubTheme subTheme)
        {
            Connection c = new();
            using var connection = c.RealizarConexao();
...
INSERT INTO sub_themes 
            (sub_theme_name, 
            id_subcategory) 
     VALUES (?Sub_theme_name, 
            ?Id_subcategory)", subTheme);

            return "Cadastro efetuado com sucesso!";
        }

        [HttpPut]
        public string UpdateSubThemes([FromBody] SubTheme subTheme)
        {
            Connection c = new();
            ...
            conncetion.Execute(@"
UPDATE sub_themes 
   SET sub_theme_name = ?Sub_theme_name, 
       id_subcategory = ?Id_subcategory 
 WHERE id_sub_theme = ?Id_sub_theme", subTheme);
