<template>
  <div class="view">
    <section class="container"
      style="padding: 30px; background-color: #212529; margin-top: 10rem; border-radius: 10px 10px 0px 0px;">
      <div class="row">
      ...
      <div class="row" style="padding-top: 1rem ;">
        <div class="col-2">
          <div class="container-fluid">
            <button class="btn btn-primary btn-custom" style="display: block;">Courses</button>
            <button class="btn btn-primary btn-custom" style="display: block;">Create courses</button>
          </div>
        </div>
        <div class="col-10">
          <div class="container-fluid" style="color: white;  padding: 20px;">
            ...
            <div class="row mt-3">
              <div class="flex" style="justify-content:center;">
                <button v-on:click="createCourse()" class="btn btn-primary" style="width:50rem;">Create</button>
              </div>
            </div>
          </div>
        </div>
