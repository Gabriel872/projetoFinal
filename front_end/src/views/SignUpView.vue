<template>
  <div class="view">
    <section class="container login-container">
      <div class="row">
        <div class="col-7">
          <div style="display: flex; min-height: 100%; align-items: center; justify-content:end;">
        ...
        <div class="col-5">
          <div class="container">
            <div class="padding">
              <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="832.20604" height="500.35625"
                viewBox="0 0 832.20604 500.35625" xmlns:xlink="http://www.w3.org/1999/xlink">
                <path
                  ...
                  transform="translate(-183.89698 -199.82188)" fill="#f1f1f1" />
                <path
                ...
                <path
                  ...
                  transform="translate(-183.89698 -199.82188)" fill="#9f616a" />
                <path
                  ...
                  transform="translate(-183.89698 -199.82188)" fill="#35d3bc" />
                ...
                <path
                  ...
                  transform="translate(-183.89698 -199.82188)" fill="#2f2e41" />
                ...
                <circle cx="465.99537" cy="251.83011" r="27.29373"
                  transform="translate(-247.58414 54.55847) rotate(-28.66324)" fill="#9f616a" />
                <path
                ...
                <path
                  ...
                  transform="translate(-183.89698 -199.82188)" fill="#35d3bc" />
                <rect x="786.20604" width="46" height="46" fill="#f1f1f1" />
                <rect x="426.20604" y="179" width="46" height="46" fill="#f1f1f1" />
                <path d="M635.92184,404.66451H999.59653V220.55582H635.92184Z"
                  transform="translate(-183.89698 -199.82188)" fill="#fff" />
                <path d="M1002.59656,407.66458H632.92176V217.5557h369.6748Zm-363.6748-6h357.6748V223.5557H638.92176Z"
                  transform="translate(-183.89698 -199.82188)" fill="#e5e5e5" />
                ...
                <rect x="723.48425" y="141.04542" width="52" height="8.05267" fill="#35d3bc" />
