          ...
          >
            <form class="form-login">
              ...
              <div class="mb-3">
                ...
                >
                <input
                  v-model="obj_login.user_password"
                  type="password"
                  class="form-control"
            ...
            <div class="padding">
              ...
              >
                ...
                <path
                  ...
                  fill="#ccc"
                />
                <circle cx="524.99994" cy="335.5" r="16" fill="#35d3bc" />
                <polygon
...
export default {
  ...
  methods: {
    ...
    async validCredentials() {
      if (
        this.obj_login.user_email == null ||
        this.obj_login.user_password == null
      ) {
    ...
    async login() {
      const request = await fetch("https://localhost:7114/api/User");
      ...
      for (var i = 0; i < this.users.length; i++) {
        if (
          this.users[i].user_email == this.obj_login.user_email &&
          this.users[i].user_password == this.obj_login.user_password
        ) {
          login = true;
