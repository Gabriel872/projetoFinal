          ...
          >
            <form class="form-login">
              <div class="mb-3">
                ...
                <input
                  v-model="obj_register.user_name"
                  type="text"
                  class="form-control"
                  id="nameUser"
              ...
              <div class="mb-3">
                ...
                >
                <input
                  v-model="obj_register.user_email"
                  type="email"
                  class="form-control"
              ...
              <div class="mb-3">
                ...
                >
                <input
                  v-model="obj_register.user_password"
                  type="password"
                  class="form-control"
...
export default {
  ...
  methods: {
    async validCredentials() {
      if (
        this.obj_register.user_email == null ||
        this.obj_register.user_password == null
      ) {
    ...
    async register() {
      ...
      await fetch(`https://localhost:7114/api/Registration`, {
        method: "post",
        headers: {
