...
SELECT courses.id_categorie FROM courses INNER JOIN categories ON categories.id_categorie = courses.id_categorie;

-- Comando para criar ligacao com as aulas, valor e usuario por curso 
SELECT * FROM courses INNER JOIN classes ON courses.id_course = classes.id_course INNER JOIN price_courses ON courses.id_price_course = price_courses.id_price_course INNER JOIN usuarios ON courses.id_author = usuarios.id_user;

-- Comando para criar ligacao dos desejos com cursos
SELECT wishes.id_course FROM wishes INNER JOIN courses ON courses.id_course = wishes.id_course;

-- Comando para listar categorias nos interesses
SELECT interests.id_categorie FROM interests INNER JOIN categories ON interests.id_categorie = categories.id_categorie;

-- Comando para criar ligacao com os comentarios, curso e usuario
SELECT ratings.id_rating FROM ratings INNER JOIN courses ON courses.id_course = ratings.id_course;

-- Comando para conectar o curso com a aula
SELECT classes.id_course FROM classes INNER JOIN courses ON courses.id_course = classes.id_course;

-- Comando para conectar a subcategoria com a categoria
SELECT subcategories.id_categorie FROM subcategories INNER JOIN categories ON categories.id_categorie = subcategories.id_categorie;

-- Comando para conectar o sub tema com a subcategoria
SELECT sub_themes.id_subcategorie FROM sub_themes INNER JOIN subcategories ON subcategories.id_subcategorie = sub_themes.id_subcategorie;

-- Comando para conectar o curso com as seções de curso
SELECT course_sections.id_course FROM course_sections INNER JOIN courses ON courses.id_course = course_sections.id_course;
