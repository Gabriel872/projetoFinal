...
SELECT courses.*, usuarios.user_name, price_courses.price_course_value
  FROM user_courses 
  INNER JOIN courses 
  ON courses.id_course = user_courses.id_course 
  INNER JOIN usuarios 
  ON usuarios.id_user = user_courses.id_user
  INNER JOIN price_courses
  ON price_courses.id_price_course = courses.id_price_course
WHERE user_courses.id_user = 1;
